...
const PRECACHE_NAME = 'hlm-precache-v196'; // bump here for new release/update toast
const RUNTIME_NAME  = 'hlm-runtime-v48';   // bump to refresh updated versioned page assets
