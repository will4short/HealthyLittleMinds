...
const PRECACHE_NAME = 'hlm-precache-v247'; // bump here for new release/update toast
const RUNTIME_NAME  = 'hlm-runtime-v101';  // bump to refresh updated versioned page assets
