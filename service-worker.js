...
const PRECACHE_NAME = 'hlm-precache-v234'; // bump here for new release/update toast
const RUNTIME_NAME  = 'hlm-runtime-v86';   // bump to refresh updated versioned page assets
