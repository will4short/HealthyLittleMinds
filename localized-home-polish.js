  ...
  function initSupportGuide() {
    ...
    var copy = {
      zhCN: {
        ...
        printable: ["动手支持", "一起使用练习单", "练习单可以把感受变成孩子能命名、涂色、书写或分享的东西。", "worksheets.html"],
      ...
      zhHant: {
        ...
        printable: ["動手支持", "一起使用學習單", "學習單可以把感受變成孩子能命名、塗色、書寫或分享的東西。", "worksheets.html"],
      ...
      ja: {
        ...
        printable: ["手を動かすサポート", "ワークシートを一緒に使う", "ワークシートは、気持ちを名前・色・言葉・共有できる形にしてくれます。", "worksheets.html"],
      ...
      ko: {
        ...
        printable: ["활동 도움", "활동지를 함께 사용해 보세요", "활동지는 감정을 이름 붙이고, 색칠하고, 쓰고, 나눌 수 있는 형태로 바꿔 줍니다.", "worksheets.html"],
